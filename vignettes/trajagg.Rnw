...
% Fix because \tt is not longer supported
% https://tex.stackexchange.com/questions/67018/problem-with-moderncv-and-bf-inside-bibliography
...
# wb_1_Track_gen <- trajaggr::as.Track(wildboars_4Ind_ltraj[1])
wb_1_Track_gen <- as(wildboars_4Ind_ltraj[1], "Track")
